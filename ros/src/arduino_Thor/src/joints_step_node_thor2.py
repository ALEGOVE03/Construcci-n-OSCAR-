...
def get_joints(data):
    ...
    #verifica que la informacion enviada sea para este brazo
    if data.name!=['Thor2_Joint1','Thor2_Joint2','Thor2_Joint3',
                'Thor2_Joint4','Thor2_Joint5','Thor2_Joint6']:
        return
    ...
    # dos variables globales  y simplimente se suma o resta los pasos
    # que correspondan
    ...
    # Finalemnte se publica el mensaje con todos los pasos para que
    # el arduino los ejecute
    jointStep.publish(joint)
    jointStep_ref.publish(joint)
...
if __name__ == '__main__':
    ...
    jointStep = rospy.Publisher('joints_steps_thor2',joints_steps,
                                                        queue_size=500)

    jointStep_ref = rospy.Publisher('steps_thor2_ref',joints_steps,
                                                        queue_size=500)

    # se define grippercmd para pubicar en el topic gripper
    grippercmd = rospy.Publisher('gripper_thor2',GripperCommand,
                                                        queue_size=100)
