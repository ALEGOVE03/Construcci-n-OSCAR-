...
ros::Publisher sensorData("sensor_raw_Thor1", &sensors );
...
ros::Subscriber<control_msgs::GripperCommand> sub("gripper_Thor1", &servocmd);
ros::Subscriber<arduino_Thor::joints_steps> arduino_joints("joints_steps_thor1", &arts);
...
//Para el brazo numero 1 el inicio o cero se encuntra en 514
...
//por lo que se debe hacer el home a esa posicion respectiva
  ...
  //while(analogRead(pot1)!=514){
   // if(analogRead(pot1) > 514){
    //  home1--;
     // Art1.moveTo(home1);
     // Art1.run();
     // delay(1); 
...
//========== Se ajusta la articulacion 1 =============
//====================================================
//Para el brazo numero 1 el inicio o cero se encuntra en 746
//Para el brazo numero 2 el inicio o cero se encuntra en 663
//por lo que se debe hacer el home a esa posicion respectiva

  int home4=0; //variable para hacer home
  while(analogRead(pot4)!=750){
    if(analogRead(pot4) > 750){
      home4++;
      Art4.moveTo(home4);
      Art4.run();
      delay(1); 
